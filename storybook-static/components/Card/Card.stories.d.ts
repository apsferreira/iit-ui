...
declare const meta: {
    title: string;
    component: import('../../../node_modules/react').ForwardRefExoticComponent<import('./Card').CardProps & import('../../../node_modules/react').RefAttributes<HTMLDivElement>>;
    tags: string[];
    argTypes: {
        hoverable: {
            control: "boolean";
    ...
    decorators: ((Story: import('@storybook/core/csf').PartialStoryFn<import('@storybook/react').ReactRenderer, {
        ...
        ref?: import('../../../node_modules/react').LegacyRef<HTMLDivElement> | undefined;
...
export declare const WithAllSubcomponents: Story;
